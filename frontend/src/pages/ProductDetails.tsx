    ...
    <Container fixed style={{ marginTop: "16px" }}>
      {
        ...
        product
        ? (<>
          <Breadcrumb categories={product?.categories?.slice(0, 1)?.shift()?.path_from_root} />
            ...
            <Grid container flexDirection="row" justifyContent="space-between">
              ...
              <Grid item flex={1}>
                ...
                <Typography variant="h5" marginBottom={BIG_MARGIN} fontSize={46}>
                  {product?.item.price.currency} {product?.item.price.amount},{product?.item.price.decimals}
                </Typography>
                <Grid item>
                  <Button
                    variant="contained"
